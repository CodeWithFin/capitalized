    ...
    <section id="why" className="mt-16 scroll-mt-24">
      ...
      <ul className="mt-4 space-y-2 text-slate-800 max-w-3xl text-lg">
        <li className="flex gap-3">
          ...
          A single AI prompt can consume 0.3 Wh of energy.
        </li>
        <li className="flex gap-3">
          <span className="mt-1 h-2 w-2 rounded-full bg-blue-600 flex-shrink-0"></span>
          At scale, millions of prompts translate into hundreds of millions of Wh annually—the equivalent energy needs of entire communities.
        </li>
      </ul>
      <p className="mt-4 text-slate-800 max-w-3xl text-lg">
      ...
      <ul className="mt-4 space-y-2 text-slate-800 max-w-3xl text-lg">
        <li className="flex gap-3">
          <span className="mt-1 h-2 w-2 rounded-full bg-blue-600 flex-shrink-0"></span>
          How can Kenya and Africa prepare to supply reliable, affordable, and sustainable energy to support AI growth?
        </li>
        <li className="flex gap-3">
          <span className="mt-1 h-2 w-2 rounded-full bg-blue-600 flex-shrink-0"></span>
          What role can the region play in attracting global players racing to close the energy gap?
        </li>
        <li className="flex gap-3">
          <span className="mt-1 h-2 w-2 rounded-full bg-blue-600 flex-shrink-0"></span>
          How do we ensure this growth is green, inclusive, and future-proof?
        </li>
      </ul>
      <p className="mt-4 text-slate-800 max-w-3xl text-lg">
